...
# !!!!!!!!!!!!!!!!!!!!!!Choose the appropriate loss function for your task!!!!!!!!!!!!!!!!!!!!!
...
model.save(os.path.join('models','multi-label-classifier.h5'))
new_model = load_model('models/multi-label-classifier.h5')
