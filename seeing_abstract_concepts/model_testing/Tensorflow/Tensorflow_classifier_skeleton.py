...
# from this tutorial: https://www.youtube.com/watch?v=jztwpsIzEGc
...
# !!!!!!!!!!!!!!!!!!!!!!Make sure the last layer has the number of outputs necessare=y for your task!!!!!!!!!!!!!!!!!!!!!
...
# !!!!!!!!!!!!!!!!!!!!!!Load your own test novel picture!!!!!!!!!!!!!!!!!!!!!
img = cv2.imread('')
...
# !!!!!!!!!!!!!!!!!!!!!!Choose where to save your model!!!!!!!!!!!!!!!!!!!!!
